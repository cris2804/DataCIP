            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Protección con PIN', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: _isLocked ? Colors.red : Colors.green)),
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              labelText: _isLocked ? 'Ingrese PIN' : 'Parámetros Editables',
                        ...
                        ElevatedButton.icon(
                          ...
                          icon: Icon(_isLocked ? Icons.lock_open : Icons.lock, color: Colors.white),
                          label: Text(_isLocked ? 'Desbloquear' : 'Bloquear', style: const TextStyle(color: Colors.white)),
                          style: ElevatedButton.styleFrom(backgroundColor: _isLocked ? Colors.green : Colors.red),
                        ),
                      ],
                    ),
                    if (_pinMessage.isNotEmpty)
                      Padding(
                        ...
                        child: Text(_pinMessage, style: TextStyle(color: _isLocked ? Colors.red : Colors.green)),
                      ),
                  ],
                ),
              ),
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Parámetros Específicos de ${widget.zona}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        helperText: 'Parámetro fijo, editable por técnico principal',
                      ),
                    ),
                    ...
                    ElevatedButton.icon(
                      ...
                      label: Text('Guardar Cambios de ${widget.zona}', style: const TextStyle(color: Colors.white)),
