...
class LugarBiomasa {
  ...
  factory LugarBiomasa.fromJson(Map<String, dynamic> map) => LugarBiomasa(
    ...
    parcelasEnTratamiento: (map['parcelas_en_tratamiento'] as num?)?.toInt() ?? 0,
    parcelasSinTratamiento: (map['parcelas_sin_tratamiento'] as num?)?.toInt() ?? 0,
...
class BiomasaDataset {
  ...
  factory BiomasaDataset.fromRawJson(String raw) {
    ...
    return BiomasaDataset(
      lugares: list.map(LugarBiomasa.fromJson).toList(),
    );
  }
